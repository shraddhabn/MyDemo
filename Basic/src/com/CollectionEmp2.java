...
public class CollectionEmp2 implements Serializable{

	private int eno;
		private String name;  
		private   double salary;

		public CollectionEmp2(int eno, String name, double salary) {
			super();
			this.eno = eno;
			this.name = name;
			this.salary = salary;
	 ...
	 class EmployeeSort2{
		...
		//li.stream().filter(x->x.getSalary() >20000).forEach(System.out::println);
			...
			li.stream().sorted((emp1,emp2)-> emp1.getName().compareTo(emp2.getName()).forEach(System.out::println));
